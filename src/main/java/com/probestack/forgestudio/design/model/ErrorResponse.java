 ...
 * ErrorResponse
 */
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-08-13T10:36:55.986768776Z[GMT]")public class ErrorResponse {
  ...
  */
   ...
   * @return errorCode
  */
    @Schema(name = "errorCode", example = "INSUFFICIENT_POINTS", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
   ...
   * @return message
  */
  @NotNull   @Schema(name = "message", example = "Member does not have enough points for this reward", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
   ...
   * @return path
  */
    @Schema(name = "path", example = "/loyalty/v1/rewards", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("path")
